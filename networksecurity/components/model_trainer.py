...
from networksecurity.utils.main_utils.utils import load_numpy_array_data,evaluate_modles
...
class ModelTrainer:
    ...
    "AdaBoost Classifier": {
        ...
        model_report: dict = evaluate_modles(X_train=X_train, y_train=y_train, X_test=X_test, y_test=y_test, models=models, params=params)
